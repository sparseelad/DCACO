...
plot(n,Y1,'-*r','LineWidth',2,'MarkerSize',10); hold on; plot(n,Y2,'-*b','LineWidth',2,'MarkerSize',10);
hold on; plot(n,Y3,'-*m','LineWidth',2,'MarkerSize',10); hold on; plot(n,Y4,'-*c','LineWidth',2,'MarkerSize',10);
