...
function []=test_fourmethod_muandhisbar_Fig()
...
[out_Elad2,newG_Elad2]=Elad(A,dd1,dd22,iter);
[out_Elad3,newG_Elad3]=Elad(A,dd1,dd23,iter);
...
plot(0:1:100,out_Elad1(1:101),'r-','LineWidth',3);hold on
plot(0:1:100,out_Elad2(1:101),'g-','LineWidth',3);hold on
plot(0:1:100,out_Elad3(1:101),'k-','LineWidth',3);hold on
...
legend('Initialization','DCACO','Elad (\gamma=0.2)','Elad (\gamma=0.5)','Elad (\gamma=0.95)','SIDCO','DMCM-PG','Welch bound')
...
plot(0:1:iter,out_Elad1,'r-','LineWidth',3);hold on
plot(0:1:iter,out_Elad2,'g-','LineWidth',3);hold on
plot(0:1:iter,out_Elad3,'k-','LineWidth',3);hold on
...
gElad3=sort(abs(newG_Elad3(:)));
newgElad3=gElad3(1:1:end-n);
[a5,b5]=hist(newgElad3,0:0.01:1);


gSIDCO=sort(abs(newG_SIDCO(:)));
newgSIDCO=gSIDCO(1:1:end-n);
[a6,b6]=hist(newgSIDCO,0:0.01:1);
...
function [out,newG]=DCACO(A,rho,iter)
...
function [out,newG]=Elad(A,dd1,dd2,iter)
...
function [out,newG] = SIDCO(A, iter)
...
function [out,newG]=DMCM_PG(A,rho,iter)
